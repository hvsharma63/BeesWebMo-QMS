                    ...
                    <div class="md-card">
                        <div class="md-card-content">
                            ...
                            <div class="uk-grid" data-uk-grid-margin>
                                ...
                                <div class="uk-width-medium-1-1">
                                    <label>Name</label>
                                    <input type="text" value="" name="cname" class="md-input" />
                                </div>
                                <div class="uk-width-medium-1-1">
                                    <label>Email</label>
                                    <input type="text" value="" name="cemail" class="md-input" />
                                </div>
                                <div class="uk-width-medium-1-1">
                                    <label>Addreess</label>
                                    <textarea cols="30" name="caddress" rows="3" class="md-input"></textarea>
                                </div>
                                <div class="uk-width-medium-1-1">
                                    <label>Phone</label>
                                    <input type="text"  value="" name="cphone" class="md-input" />
                                </div>
                                <div class="uk-width-medium-1-1">
                                    <label>Location</label>
                                    <input type="text"  value="" name="clocation" class="md-input" />
                                </div>
